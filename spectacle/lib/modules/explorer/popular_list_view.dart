...
import 'package:spectacle/modules/explorer/categorie_view.dart';
...
class PopularListView extends StatefulWidget {
  ...
  PopularListView({Key? key, required this.callBack, required this.animationController}) : super(key : key);
...
class _PopularListViewState extends State<PopularListView> with TickerProviderStateMixin {
  var popularList = SalleListData.popularList;
          ...
          builder: (context, snapshot) {
            if(!snapshot.hasData){
              ...
              return ListView.builder(
                padding: EdgeInsets.only(top: 0.0, bottom: 0.0,right: 24, left:8),
                ...
                itemBuilder: (context, index) {
                  ...
                  var animation = Tween(begin: 0.0, end:1.0).animate(CurvedAnimation(
                    ...
                    // popular animation photo and text view
                    return CategoryView(
                      callback: () {
