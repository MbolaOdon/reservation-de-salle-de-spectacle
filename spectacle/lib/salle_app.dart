...
import 'package:spectacle/common/common.dart';
...
import 'package:spectacle/modules/pages/splashScreen.dart';
...
class _MotelAppState extends State<ReservationApp> {
  @override
...
// when this application open every time on that time we check and update some theme data
  ...
  Map<String, WidgetBuilder> _buildRoutes() {
    return {
      ...
      // RoutesName.SingUp: (BuildContext context) => SinupPage(),
      // RoutesName.Home: (BuildContext context) => HomePage(),
      // RoutesName.SearchScreen: (BuildContext context) => SearchScreen(),
      // RoutesName.SalleHomeScreen: (BuildContext context) => SalleHomeScreen(),
    };
  }
}
