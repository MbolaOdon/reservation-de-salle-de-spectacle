...
class AppTheme {
  ...
  static Color get lightSecondaryBackground =>
    isLightMode ? Color.fromARGB(255, 234, 234, 234) : Color(0xff494949);

   

      static Color get secondaryBackground =>
    isLightMode ? Color(0XFFF5F5F5) : Color(0XFFF5F5F5);
  ...
  static TextTheme _buildTextTheme(TextTheme base) {
    ...
    return base.copyWith(
      headlineLarge: getTextStyle(_fontType, base.headlineLarge!),
      headlineMedium: getTextStyle(_fontType, base.headlineMedium!),
      headlineSmall: getTextStyle(_fontType, base.headlineSmall!.copyWith(
  ...
  static Color getColor(ColorType _colordata) {
    switch (_colordata) {
      case ColorType.Verdigris:
        return isLightMode ? Color(0xfff96d37) : Color(0xffff5506);
