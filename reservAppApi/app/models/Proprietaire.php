...
class Proprietaire {
    ...
    protected function get_pwd_from_db($login) {
        ...
        $stmt = $this->database->mysqli->prepare("SELECT password, idPro, role FROM Proprietaire WHERE email = ? OR phone = ?");
    ...
    public function save($nomPrenom, $phone, $addresse, $email, $password, $password_confirmed) {
        ...
        // Utiliser une requête préparée pour éviter les injections SQL
        $stmt = $this->database->mysqli->prepare("INSERT INTO Proprietaire (nomPrenom, phone, adresse, email, password) VALUES (?, ?, ?, ?, ?)");
    ...
    public function update($id, $nomPrenom, $phone, $adresse, $email, $password = null) {
        ...
        $query = "UPDATE Proprietaire SET nomPrenom = ?, phone = ?, adresse = ?, email = ?";
    ...
    public function delete($id)
    {
        ...
        // Utiliser une requête préparée pour éviter les injections SQL
        $stmt = $this->database->mysqli->prepare("DELETE FROM Proprietaire WHERE idPro = ?");
    ...
    public function all()
    {
        ...
        $stmt = $this->database->mysqli->prepare("SELECT * FROM Proprietaire");
        $stmt->execute();
        $result = $stmt->get_result();
    ...
    public function find($data)
    {
        ...
        $stmt = $this->database->mysqli->prepare("SELECT * FROM Proprietaire WHERE idPro = ?");
